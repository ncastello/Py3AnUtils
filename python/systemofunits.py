...
.. module:: systemofunits
   :platform: Unix
	  ...
	  way to import is: from Py3AnUtils.systemofunits import unit
	  
	  Example:
	    from Py3AnUtils.systemofunits import unit 
		L=10*unit.m
		...
...
# when using "from Py3AnUtils.systemofunits import *"
...
for i in BASEUNITS.keys():
	s = UNITSYMBOL[i][0]
	a = unitobject(i)
	for attr in [s]+list(map(lambda x: x+s,list(_prefixes.keys())+list(_suffixes.keys()))):
