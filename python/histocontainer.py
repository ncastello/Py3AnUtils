...
class HistoContainer():
    ...
    def __init__(self):
        ...
        of useful data-members, the main initializator methods are:
            ...
            * create_and_book_histo: to book histograms which should be
                    created by the class
        """
        from Py3AnUtils.pyanfunctions import ExtraOpt
    ...
    def book_histo(self,h,**kwd):
        ...
        """
        import ROOT
        from Py3AnUtils.pyanfunctions import set_attr_plotobject
    ...
    def plot(self,name,plotname,canvas=None,**kwd):
        ...
        """
        from Py3AnUtils.pyanfunctions import drawlegend
        from Py3AnUtils.plotstyles import setpalette
